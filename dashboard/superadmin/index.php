...
<div class="alert alert-info d-flex align-items-center mb-4 py-2" role="alert">
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar3 me-2" viewBox="0 0 16 16">
        ...
        <path d="M6.5 0a.5.5 0 0 0-.5.5V1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5V.5a.5.5 0 0 0-.5-.5h-3zM5 1V.5a1.5 1.5 0 0 1 3 0V1h-3z"/>
    </svg>
    <strong>Periode Data:</strong> 
    <span class="ms-2"><?= $filter === 'hari' ? "Hari Ini (" . date('d F Y') . ")" : "Bulan " . date('F Y'); ?></span>
</div>
            ...
            <div class="card border-0 shadow-sm h-100" style="background-color: rgba(25, 135, 84, 0.1);">
              <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <p class="text-muted small mb-1">Total Pengiriman</p>
            ...
            <div class="card border-0 shadow-sm h-100" style="background-color: rgba(255, 193, 7, 0.1);">
              <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        <p class="text-muted small mb-1">Total Surat Jalan</p>
